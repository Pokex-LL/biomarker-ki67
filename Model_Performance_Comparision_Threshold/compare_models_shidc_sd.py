...
def main():
    ...
    ap.add_argument("--patch_size", type=int, default=19)

    ap.add_argument("--cellpose_model_type", type=str, default="cpsam")
    ap.add_argument("--cellpose_diameter", type=float, default=15)
    ...
    ap.add_argument("--cellpose_min_size", type=int, default=5)

    ap.add_argument("--batch_infer", type=int, default=32)
