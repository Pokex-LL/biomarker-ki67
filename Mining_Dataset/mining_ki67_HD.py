...
BASE_DIR = Path("/media/HDD2/SHIDC-B-Ki-67/bare images/Train")
OUTPUT_DIR = Path("/media/HDD2/SHIDC-B-Ki-67/HD_KI67_Patch_SAM")
...
def generar_dataset_hd():
    ...
    print(f"Iniciando Minería de Datos HD")
